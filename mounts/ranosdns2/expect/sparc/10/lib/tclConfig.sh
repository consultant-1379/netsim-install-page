...
TCL_EXTRA_CFLAGS='-O2 -L/usr/local/pgsql/lib -R/usr/local/pgsql/lib -L/usr/local/lib -R/usr/local/lib -L/usr/local/ssl/lib -R/usr/local/ssl/lib -L/usr/openwin/lib -R/usr/openwin/lib -I/usr/local/rrdtool-1.2.19/include -pipe -I/usr/local/include -I/usr/local/ssl/include -I/usr/local/pgsql/include -I/usr/local/include/ncurses -I/usr/local/BerkeleyDB.4.2/include -I/usr/openwin/include -I/usr/local/rrdtool-1.2.19/include'
...
TCL_LD_FLAGS='-L/usr/local/lib -R/usr/local/lib -R/usr/lib -L/usr/local/pgsql/lib -R/usr/local/pgsql/lib -L/usr/lib -R/usr/openwin/lib -L/usr/openwin/lib -L/usr/local/ssl/lib -R/usr/local/ssl/lib -L/usr/local/BerkeleyDB.4.2/lib -R/usr/local/BerkeleyDB.4.2/lib -L/usr/X11R6/lib -R/usr/X11R6/lib '
...
# build directory.
TCL_BUILD_LIB_SPEC='-L/bigdisk/SOURCES/S10/tcl8.5.3/unix -ltcl8.5'
...
# compiled.
TCL_SRC_DIR='/bigdisk/SOURCES/S10/tcl8.5.3'
...
# build directory.
TCL_BUILD_STUB_LIB_SPEC='-L/bigdisk/SOURCES/S10/tcl8.5.3/unix -ltclstub8.5'
...
TCL_BUILD_STUB_LIB_PATH='/bigdisk/SOURCES/S10/tcl8.5.3/unix/libtclstub8.5.a'
